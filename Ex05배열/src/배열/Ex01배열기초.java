...
public class Ex01배열기초 {
	...
	public static void main(String[] args) {
		...
		// 배열 선언하는 방법
		// 자료형[] 변수명 = new 자료형[0,배열을 몇칸짜리로 할지 숫자입력];
		...
		// numbers --> 내가 만든 5칸짜리 배열이 어디에 있는지
		//             주소값을 참조하는 레퍼런스 변수
		...
		//      해당하는 데어터가 어디에 저장되어 있는지 주소값이 필요하다!
		...
		// 상단에서 Window - Prefernces -> show heap status
		
		// 배열 안에 데이터를 저장하는 방법
		// --> 정확하게 방번호(인덱스 번호)를 지정한 후 저장
