...
public class Ex01사용법 {
	...
	public static void main(String[] args) {
		...
		// jar파일 추가하는 방법
		// 프로젝트 선택 -> 마우스 우클릭 -> build path 클릭 -> configure build path
		// -> libraries 탭 선택 -> class path 선택 -> 우측에 add jars 클릭
		// -> 원하는 jar파일 선택해서 추가 -> apply and close 
		
		// 노래 재생을 가능하게 해주는 도구 생성
		MP3Player mp3 = new MP3Player();
		
		// 1) 노래 재생하기
		mp3.play("C:\\Users\\USER\\Desktop\\JavaStudy\\MusicPlayer\\player\\Smart.mp3");
